...
openai.api_key = "[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]"
...
def listen_for_wake_word(audio):
    ...
    global bing_engine
    custom_path= "D:/voice/bing-voice/save.wav"
    with open(custom_path, "wb") as f:
        f.write(audio.get_wav_data())
    result = tiny_model.transcribe(custom_path)
...
def prompt_bing(audio):
    ...
    global bing_engine
    try:
        custom_path= "D:/voice/bing-voice/prompt.wav"
        with open(custom_path, "wb") as f:
            f.write(audio.get_wav_data())
        result = base_model.transcribe(custom_path)
